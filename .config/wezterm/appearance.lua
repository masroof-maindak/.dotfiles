...
-- appearance is light or dark. darkman drives the OS appearance
-- via org.gnome.desktop.interface color-scheme (see
-- ~/.local/share/darkman/gtk.sh), so this follows darkman's mode.
